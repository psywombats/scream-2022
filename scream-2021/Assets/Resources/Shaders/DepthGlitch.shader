Shader "Scream2021/DepthGlitch" {
    ...
    SubShader {
        ...
        float _ResolutionX;
        float _ResolutionY;
        float _DLimitEnabled, _DLimitMax, _DLimitMin;
        float _Alpha;
        ...
        void surf(Input IN, inout SurfaceOutput o) {
            ...
            if (_DLimitEnabled > 0) {
                ...
                float depth = IN.screenPos.w;
                float dt = saturate(smoothstep(_DLimitMin, _DLimitMax, depth));
                c = c * dt + origVal * (1 - dt); 
            }
