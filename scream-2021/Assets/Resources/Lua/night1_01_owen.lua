...
walk('n1_owen0', 1, 'EAST')
faceOtherToward('n1_owen0', 'hero')
wait(.2)
...
speak("Owen", "Someone needs to be cautious around here. Since Cecily disappeared I feel like I have to be.", 'n1_owen0')
