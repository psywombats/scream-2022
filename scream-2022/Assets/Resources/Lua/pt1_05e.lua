...
if not getSwitch('pt1_05e') then
	...
	speak('ARIEL', "I can dream whatever I like. If Braulio wants that island vacation, then I dream of an island. Then we capture it on Gazer, and anyone can replay it. It's called 'mirroring'.")
	expr('SUMI', nil)
...
if not getSwitch('pt1_05c') then
	speak('ARIEL', "I don't think our prototype Gazer is in use. Would you like to do the demo now?")
