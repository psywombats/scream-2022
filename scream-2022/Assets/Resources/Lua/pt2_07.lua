...
speak('BRAULIO', "Looks like it. She'll enter REM sleep soon and then Recurser will start the replay.")
speak('ARIEL', "It's really not a pleasant dream.")
expr('BRAULIO', 'angry')
speak('BRAULIO', "I'm pretty sure any dream with Sumi in it is by default a nightmare.")
expr('BRAULIO', nil)
...
speak('ARIEL', "You didn't answer me. And if you can't tell, I'm upset about this.")
speak('BRAULIO', "It...")
...
speak('ARIEL', "So we found side effects. Is that why Chris left?")
