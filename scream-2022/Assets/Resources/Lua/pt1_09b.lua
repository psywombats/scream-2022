...
if not getSwitch('pt1_09b') then
	...
	speak('CHRIS', "None. But maybe that's a good thing. If Noemi perfects Recurse before I perfect a cyanophazepam analog, that means we don't need any drugs in the first place.")
	...
	speak('CHRIS', "But I don't feel comfortable here with her around. Do we really want to go public with a version of Recurse that still requires the patient to take Bluepill?")
	speak('ARIEL', "That's why we're working on a workaround.")
	speak('CHRIS', "But if we don't find that workaround before the next version of Recurse is complete... You think a venture capitalist would care?")
	expr('CHRIS', 'pain')
