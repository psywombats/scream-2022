...
expr('CHRIS', nil)
speak('CHRIS', "Well, I dug up some more information on long-term Bluepill use. There are other labs out there working on applications of Bluepill, and nothing as benign as Recurser.")
expr('CHRIS', 'thinking')
...
enter('CHRIS', 'e')
speak('CHRIS', "Oh and don't let Sumi anywhere near Recurser. Probably not Braulio either. I'll explain later.")
exitNVL()
