...
speak("Tess", "The stairs aren't what you think.")
speak("Tess", "They lead to the research lab attached to the ward, not the outside world.")
...
faceOther('d2_owen0', 'hero')
speak("Owen", "Never mind.", 'd2_owen0')
faceTo('hero', 'd2_owen0')
